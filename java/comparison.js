...
function createKeyValueDivs(data, container, isFirstObject) {
    ...
    for (var i = 0; i < keys.length; i++) {
        ...
        // Add different class name to first 3 key-value pairs
        if (isFirstObject && i < 3) {
            keyElement.classList.add("first-object-key");
        }

        // Add additional class name to all keys in the first object
        if (isFirstObject) {
            keyElement.classList.add("show-card");
        }
        ...
        if (typeof value === "object" && value !== null) {
            createKeyValueDivs(value, valueElement, false);
        } else {
...
for (var i = 0; i < filteredObjects.length; i++) {
    ...
    createKeyValueDivs(cardData, infoContainer, i === 0);
...
// function createKeyValueDivs(data, container) {
//     for (var key in data) {
...
//             if (typeof value === "object" && value !== null) {
//                 createKeyValueDivs(value, valueElement);
//             } else {
//                 valueElement.textContent = value;
//             }
...
//     createKeyValueDivs(cardData, infoContainer);
